...
* **Blender Extension/Add-on** - `.py,.pyi,.toml,.md,.txt,.rst,.json,.yaml,.yml` (excludes `__pycache__/`, `.git/`, `.bkp/`, build output)
* **Python Project** - `.py,.pyi,.toml,.cfg,.ini,.md,.txt,.rst,.yaml,.yml,.json` (excludes `__pycache__/`, virtualenvs, caches, build output)
